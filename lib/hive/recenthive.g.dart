...
part of 'recenthive.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class RecentHiveAdapter extends TypeAdapter<RecentHive> {
  @override
  final int typeId = 0;

  @override
  RecentHive read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, RecentHive obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.bitrate)
